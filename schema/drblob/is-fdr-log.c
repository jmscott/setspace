/*
 *  Synopsis:
 *	Is a stream a well formed flow detail log file?
 *  Description:
 *  	A flow detail log file consists of lines of ascii text
 *  	with 6 tab separated fields matching
 *
