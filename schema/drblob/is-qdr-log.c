/*
 *  Synopsis:
 *	Is a stream a well formed query detail record (qdr) log file?
 *  Description:
 ...
 *		\t
 *		query name: [a-zA-Z][a-zA-Z0-9_]{0,63}
 *		\t
...
/*
 *  Scan for terminal_class: OK, ERR
 */
static void
