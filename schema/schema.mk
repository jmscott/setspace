...
#  Variables for myblob schema
MYBLOB_ROOT=$(SETSPACE_PREFIX)/schema/myblob
MYBLOB_PREFIX=$(FFFILE_ROOT)
MYBLOB_USER=$(SETSPACE_USER)
MYBLOB_GROUP=$(SETSPACE_GROUP)

#  Variables for curl7 schema
CURL7_ROOT=$(SETSPACE_PREFIX)/schema/curl7
CURL7_PREFIX=$(FFFILE_ROOT)
