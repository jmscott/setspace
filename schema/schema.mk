...
#  Variables for mycore schema
MYDASH_ROOT=$(SETSPACE_PREFIX)/schema/mycore
MYDASH_PREFIX=$(MYDASH_ROOT)
...
#  Variables for infozip3 schema
INFOZIP3_ROOT=$(SETSPACE_PREFIX)/schema/infozip3
INFOZIP3_PREFIX=$(INFOZIP3_ROOT)
INFOZIP3_USER=$(SETSPACE_USER)
INFOZIP3_GROUP=$(SETSPACE_GROUP)

#  Variables for drblob schema for parsing setpace description records
DRBLOB_ROOT=$(SETSPACE_PREFIX)/schema/drblob
DRBLOB_PREFIX=$(DRBLOB_ROOT)
DRBLOB_USER=$(SETSPACE_USER)
DRBLOB_GROUP=$(SETSPACE_GROUP)

#  Variables for udigset schema for parsing setpace description records
UDIGSET_ROOT=$(SETSPACE_PREFIX)/schema/udigset
UDIGSET_PREFIX=$(UDIGSET_ROOT)
UDIGSET_USER=$(SETSPACE_USER)
UDIGSET_GROUP=$(SETSPACE_GROUP)

#  Variables for udigset schema for parsing setpace description records
SETOPS_ROOT=$(SETSPACE_PREFIX)/schema/setops
SETOPS_PREFIX=$(SETOPS_ROOT)
SETOPS_USER=$(SETSPACE_USER)
SETOPS_GROUP=$(SETSPACE_GROUP)
